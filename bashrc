...
source ${HOME}/bash_autosetup/git-prompt.sh
...
alias ebrc='vim ${HOME}/bash_autosetup/bashrc'
...
source ${HOME}/bash_autosetup/git-completion.bash
...
export PATH=${PATH}:${HOME}/bash_autosetup/bin
